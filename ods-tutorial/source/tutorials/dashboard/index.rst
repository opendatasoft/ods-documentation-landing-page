...
2. Click on the + New page button, to create a new content page.
...
4. Click the Save button to save your newly created content page.
...
6. Click on </> Edit in expert mode to access the HTML/CSS code of the page. A pop up will appear, click on "Yes, switch to expert mode" for confirmation matter.
...
8. Click on the Open page button to see the current result of your page.
...
15. Save your page and click the Open page button: there is now a table visualization in our page!
...
20. Save your page and click the Open page button: this is what your page should look like by now!
...
22. Save your page and click the Open page button: our page now has a title!
